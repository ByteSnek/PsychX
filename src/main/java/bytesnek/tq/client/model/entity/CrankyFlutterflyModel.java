...
public class CrankyFlutterflyModel extends EntityModel<CrankyFlutterfly>
{
    ...
    @Override
    public void setupAnim(@NotNull CrankyFlutterfly flutterfly, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
