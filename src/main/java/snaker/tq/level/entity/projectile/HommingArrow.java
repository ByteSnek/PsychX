package snaker.tq.level.entity.projectile;
...
import snaker.snakerlib.level.entity.SnakerProjectile;
 ...
 **/
public class HommingArrow extends SnakerProjectile
{
    ...
    {
        super(Rego.ENTITY_HOMMING_ARROW.get(), shooter, level);
    ...
    {
        return Rego.ENTITY_HOMMING_ARROW.get();
    }
