...
import xyz.snaker.tq.utility.level.FlatLayer;
import xyz.snaker.tq.utility.level.FlatLayerList;
...
public class ConcreteFlatLevelPreset
{
    public static FlatLevelGeneratorPreset create(BootstapContext<FlatLevelGeneratorPreset> context)
    {
        ...
        FlatLayerList list = FlatLayerList.create();

        list.addAll(FlatLayer.create(5, Blocks.WHITE_CONCRETE), FlatLayer.create(Blocks.BEDROCK));
