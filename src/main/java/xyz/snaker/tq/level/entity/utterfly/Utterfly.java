package xyz.snaker.tq.level.entity.utterfly;
...
public class Utterfly extends FlyingHostile implements Comatosian
{
    ...
    public static final ServerBossEvent BOSS_EVENT = new ServerBossEvent(Component.translatable("entity.tq.utterfly"), BossEvent.BossBarColor.GREEN, BossEvent.BossBarOverlay.PROGRESS);
    ...
    {
        BOSS_EVENT.setProgress(getHealth() / getMaxHealth());
    }
