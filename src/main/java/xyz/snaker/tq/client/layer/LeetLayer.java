...
public class LeetLayer extends RenderLayer<Leet, LeetModel> implements SimpleRenderTypeProcessor
{
    ...
    {
        RenderType type = create(StringStuff.placeholderWithId(), new Pair<>(DefaultVertexFormat.POSITION_TEX, sampler(Shaders::getCrystalized, new ResourcePath("textures/sampler/noise_white.png"), false, false)));
