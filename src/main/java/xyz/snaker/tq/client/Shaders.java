...
public class Shaders
{
    ...
    static void register(RegisterShadersEvent event)
    {
        ...
        registerShader("stars", shaderInstance ->
        {
            blackStars = Sneaky.cast(shaderInstance);
        ...
        registerShader("stars", shaderInstance ->
        {
            whiteStars = Sneaky.cast(shaderInstance);
        ...
        registerShader("stars", shaderInstance ->
        {
            redStars = Sneaky.cast(shaderInstance);
        ...
        registerShader("stars", shaderInstance ->
        {
            greenStars = Sneaky.cast(shaderInstance);
        ...
        registerShader("stars", shaderInstance ->
        {
            blueStars = Sneaky.cast(shaderInstance);
        ...
        registerShader("stars", shaderInstance ->
        {
            yellowStars = Sneaky.cast(shaderInstance);
        ...
        registerShader("stars", shaderInstance ->
        {
            pinkStars = Sneaky.cast(shaderInstance);
        ...
        registerShader("stars", shaderInstance ->
        {
            purpleStars = Sneaky.cast(shaderInstance);
        ...
        {
            plain = Sneaky.cast(shaderInstance);
        ...
        {
            blurFog = Sneaky.cast(shaderInstance);
        ...
        {
            pulse = Sneaky.cast(shaderInstance);
        ...
        {
            crystalized = Sneaky.cast(shaderInstance);
        ...
        LOGGER.infof("Registered all shaders in [] seconds", DurationFormatUtils.formatDuration(System.currentTimeMillis() - time, "s.S"));
    }
