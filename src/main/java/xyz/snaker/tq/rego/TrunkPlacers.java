...
public class TrunkPlacers
{
    ...
    public static final RegistryObject<TrunkPlacerType<GeometricTrunkPlacer>> GEOMETRIC = REGISTRAR.register("geometric", () -> new TrunkPlacerType<>(GeometricTrunkPlacer.CODEC));
}
