...
public class Blocks
{
    ...
    public static final RegistryObject<Block> COMA_STONE = registerBlockWithItem("coma_stone", () -> new Block(DefaultBlockProperties.NETHER.apply(MapColor.COLOR_GRAY)));
    ...
    public static final RegistryObject<Block> CATNIP = registerBlockWithItem("catnip", () -> new FlowerBlock(Effects.SYNCOPE::get, Maths.secondsToTicks(5), DefaultBlockProperties.PLANT.apply(MapColor.COLOR_CYAN), Keys.COMATOSE_NYLIUM, true));
